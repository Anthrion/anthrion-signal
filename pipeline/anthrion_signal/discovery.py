...
def discovery_text(value):
    ...
    # These are distinctive enough not to need word boundaries, and the product is
    # written AI_Bietercockpit and AI-Bietercockpit as well as AI Bietercockpit.
